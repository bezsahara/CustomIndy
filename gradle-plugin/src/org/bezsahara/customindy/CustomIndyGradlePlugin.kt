package org.bezsahara.customindy

import org.gradle.api.Project
import org.gradle.api.provider.Provider
import org.bezsahara.customindy.BuildConfig.ANNOTATIONS_LIBRARY_COORDINATES
...
class CustomIndyGradlePlugin : KotlinCompilerPluginSupportPlugin {
    override fun apply(target: Project) {
        target.extensions.create("customindyPlugin", SimpleGradleExtension::class.java)
    }
