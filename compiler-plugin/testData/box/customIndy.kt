...
object CustomBootstrap {
    ...
    fun bootstrap(
        ...
        val mh = MethodHandles.constant(String::class.java, "id=$id")
...
@CustomIndy(
    ...
    bsmOwner = CustomBootstrap::class,
    bsmName = "bootstrap",
...
fun greetCustom(): String = "fallback"

fun box(): String {
    val result = @IndyInt(index = 0, value = 7) greetCustom()
    return if (result == "id=7") "OK" else "Fail: $result"
}
